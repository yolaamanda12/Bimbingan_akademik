            ...
            <!-- inni konten  -->
             ...
             <form action="{{url('prodi/update/'.$prodi->id)}}" method="POST">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $prodi->kode }}" id="kode" name="kode" required>
                        </div>
                        <div class="form-group">
                          <label for="nama">Nama Prodi</label>
                          <input type="text" class="form-control" value="{{ $prodi->nama }}" id="nama" name="nama" required>
                      </div>
